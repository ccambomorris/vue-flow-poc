...
import { VueFlow, addEdge, MiniMap, Controls, Background, Node, Elements, FlowInstance, FlowTransform, SnapGrid, Connection, Edge, FlowEvents, MarkerType } from "~/packages/designer";
...
const nodeStrokeColor = (n: Node): string => {
  if (n.style && n.style["background"]) return n.style["background"] as string;
