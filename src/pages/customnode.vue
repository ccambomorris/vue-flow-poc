  ...
  <div style="height: 100vh">
    <VueFlow v-model="elements" :style="{ backgroundColor: bgColor }">
      <template #node-selectorNode="props">
        <DesignerColorSelectorNode v-bind="props" />
      </template>
...
import { ConnectionMode, Controls, Elements, isEdge, MiniMap, Node, Position, SnapGrid, useVueFlow, VueFlow } from "~/packages/designer";
