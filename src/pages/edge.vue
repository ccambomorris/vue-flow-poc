  ...
  <div style="height: 100vh">
    <VueFlow :fit-view-on-init="true" :snap-to-grid="true">
      <template #edge-custom="props">
        <DesignerCustomEdge v-bind="props" />
      </template>
      <template #edge-custom2="props">
        <DesignerCustomEdge2 v-bind="props" />
      </template>
      <MiniMap />
      <Controls />
      <Background />
...
import { VueFlow, MiniMap, Controls, Background, MarkerType, useVueFlow, Edge, Node } from "~/packages/designer";
import CustomLabel from "~/components/designer/custom-label.vue";
